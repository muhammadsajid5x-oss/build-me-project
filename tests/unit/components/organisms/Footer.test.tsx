...
import { Footer } from '../../../../packages/ui/src/components/organisms/Footer/Footer';
...
describe("Footer Organism", () => {
  ...
  it("renders copyright", () => {
    render(<Footer copyright="Â© 2026 Test Brand" />);
    expect(screen.getByText("Â© 2026 Test Brand")).toBeInTheDocument();
  });
});
